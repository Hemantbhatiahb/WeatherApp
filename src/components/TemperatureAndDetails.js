...
import { formatToLocalTime, getIconUrlFromCode } from "../service/weatherService";

function TemperatureAndDetails({weather}) {
    const {details,temp,icon,feels_like,humidity,speed,sunrise,sunset,temp_min,temp_max,timezone} = weather
  return (
    <React.Fragment>
      ...
      <div className="text-white flex flex-row items-center justify-between py-3">
        <img src={getIconUrlFromCode(icon)} alt="weather icon" className="w-20" />
